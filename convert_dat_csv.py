...
# Example usage:
directory_path = "/working/directory  # Set the correct directory path where the .dat files are located
output_csv_file = "/output/path/AF3.csv"  # Set the path for the output CSV file
